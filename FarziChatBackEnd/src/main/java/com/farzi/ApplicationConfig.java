...
public class ApplicationConfig {
	...
	public @Bean MongoClient mongoClient() throws UnknownHostException {
        return new MongoClient(new ServerAddress("ds159776.mlab.com", 59776), new ArrayList<MongoCredential>() {

            {
                add(MongoCredential.createCredential("kapil", "vconnect", "kapil0511".toCharArray()));
            }
        });
    }
    ...
    public MongoDbFactory mongoDbFactory() throws Exception {
		return new SimpleMongoDbFactory(mongoClient(), "vconnect");
    }
